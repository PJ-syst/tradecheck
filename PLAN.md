...
- Implemented: browser OAuth with PKCE, loopback callback, and encrypted Windows-user credential storage. Metadata discovery was verified live. User authorization and end-to-end account verification remain pending; automatic refresh is not advertised by Binance and is not implemented.
